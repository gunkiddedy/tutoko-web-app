  ...
  methods: {
    ...
    getHargaBarang: function getHargaBarang(param) {
      ...
      axios.get("/api/get-harga-barang/" + param).then(function (response) {
        ...
        _this3.harga.grosir = response.data.harga_jual_grosir;
        _this3.penjualan.harga_jual = response.data.harga_jual_standar;
        console.log(response);
      })["catch"](function (err) {
        console.log(err);
      });
                          ...
                          [
                            _c("div", {}, [
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "focus:outline-none focus:ring-2 focus:ring-yellow-600 px-6 py-2 w-full rounded bg-yellow-500 font-bold text-white text-xl",
                                  on: {
                            ...
                            _c("div", {}, [
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "focus:outline-none focus:ring-2 px-6 py-2 w-full rounded bg-blue-500 font-bold text-white text-xl",
                                  on: {
                                    click: function($event) {
                            ...
                            _c(
                              ...
                              [
                                ...
                                _c("date-picker", {
                                  ...
                                  model: {
                                    value: _vm.penjualan.tanggal,
                                    callback: function($$v) {
                                      _vm.$set(_vm.penjualan, "tanggal", $$v)
                                    },
                                    expression: "penjualan.tanggal"
                                  }
                                })
                              ],
                              1
