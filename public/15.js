                            ...
                            [
                              _c("div", { staticClass: "px-0 md:px-4 my-2" }, [
                                ...
                                _c(
                                  "select",
                                  {
                                    ...
                                    staticClass:
                                      "w-full px-5 py-2 md:py-1 rounded-lg text-gray-500 focus:outline-none focus:shadow-inner border-2 border-blue-200 bg-white appearance-none uppercase text-lg font-bold",
                                    on: {
                              ...
                              _c("div", { staticClass: "px-0 md:px-4 my-2" }, [
                                ...
                                _c("input", {
                                  ...
                                  staticClass:
                                    "w-full px-4 py-2 md:py-1 focus:bg-blue-50 text-gray-700 rounded border-2 border-blue-200 bg-white uppercase text-lg font-bold",
                                  attrs: {
                                    id: "jumlah",
                                    type: "number",
                                    min: "0",
                              ...
                              _c("div", { staticClass: "px-0 md:px-4 my-2" }, [
                                ...
                                _c("input", {
                                  ...
                                  staticClass:
                                    "w-full px-4 py-2 md:py-1 text-gray-700 border-2 border-blue-200 bg-white rounded uppercase text-lg font-bold",
                                  attrs: {
                                    id: "barang_satuan",
                                    type: "number",
                                    min: "0",
